  ...
  return (
	...
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            {error? <p className=' text-red-700 text-base'>Incorrect Email or Password</p> : ""}

            <p>If you don't have an account, Please<Link to= '/signup' className=' text-blue-700 underline'> Sign-up</Link> Here</p>

						<div className="relative">
							<button className="bg-blue-700 text-white rounded-md px-4 py-2 hover:bg-black">Login</button>
						</div>
					</form>
				</div>
